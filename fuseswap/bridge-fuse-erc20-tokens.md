...
Once the transaction is confirmed on chain, the **“Transfer”** can be clicked and transaction has to be approved. Once this second transaction is confirmed onchain the CURVE balance in the same address on Curve network will have the updated balance of CURVE which can be checked through [https://curvescan.io/](https://curvescan.io/) 
