---
description: This tutorial will explain how to delegate/stake/unstake your CURVE.
---

# Staking tutorial

Note: You can only stake CURVE which is on Curve network. Please make sure you have changed into Curve network in Metamask while doing any transactions on staking UI. 

How to Stake CURVE:

**Step 1:**

Navigate to staking.curvescan.io and login to your wallet through metamask. Make sure you are on Curve network. If you are not please follow the instructions [**here**](https://docs.curvescan.io/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of CURVE you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 

![](.gitbook/assets/3%20%286%29.png)

**How to Unstake CURVE:**
