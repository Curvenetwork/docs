...
**Please use this tutorial at your own risk as it involves using Etherscan UI/Curve explorer to relay the tokens. This tutorial is applicable only for TL20 tokens other than CURVE. Do not use this tutorial to transfer CURVE.** 
...
Once the transaction is confirmed on-chain we wait for 2 blocks to ensure security of transaction and then the USDT tokens should appear on your Curve address and have been swapped from Ethereum mainnet to Fusenet.
...
https://curvescan.io/address/0xFaDbBF8Ce7D5b7041bE672561bbA99f79c532e10/write\_proxy

![](../../.gitbook/assets/4%20%286%29.png)

Make sure that the network is CURVE network. If you have not added Curve network please follow the instructions [here](https://docs.curvescan.io/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
[https://curvescan.io/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write\_proxy](https://curvescan.io/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write_proxy)
...
After the transaction is confirmed on Curve network, the bridge oracle will relay your tx on Ethereum. No need to wait for additional confirmations as Curve is PoS network. After sometime you should be able to see the successful transfer of the token on your TL20 address.
