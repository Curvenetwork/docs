# How to add Curve to your Metamask
...
{% hint style="danger" %}
**Note: Please make sure you send Curve assets to only other fuse chain wallets and not any exchanges. We won't be able to retrieve the funds in case fuse assets are sent to non Curve chain supported wallets/exchanges.**
{% endhint %}
