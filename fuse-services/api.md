...
The Curve Studio REST API for accessing the data and the services of the Curve network in a simple way. You can use this API to query and interact with the objects of the Curve network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Curve network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Curve\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Curve network |
...
| homeBridgeAddress | `String` | Bridge address on the Curve network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Curve network |
...
Community is a set of contracts and services. Members of the community are users of the Curve network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Curve network |
| homeTokenAddress | `String` | Address of the community token on the Curve network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Curve network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Curve network |
...
Entity is an account on the Curve network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Curve network |
